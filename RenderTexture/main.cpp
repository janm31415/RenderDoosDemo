...
class canvas : public Fl_Gl_Window
  ...
  private:
    ...
    void _init_engine()
      ...
      simple_mat->set_texture(_texture_id, TEX_WRAP_REPEAT | TEX_FILTER_NEAREST);
  ...
  private:
    ...
    int32_t _texture_id, _geometry_id;
...
#endif
  render_window* window = new render_window(x, y, w, h, "RenderTexture");
...
int _main(int argc, char** argv)
  ...
  try
    {
    window = new_view();
    Fl_Color c = (Fl_Color)FL_DARK_RED;
